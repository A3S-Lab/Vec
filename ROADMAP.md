...
the all-feature baseline has 249 passing unit/integration tests plus four doctests;
the default and no-default feature suites each pass 246 unit/integration tests,
