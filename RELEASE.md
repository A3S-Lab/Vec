...
checksum remain historical evidence. The `0.1.1` candidate is generated by
the versioned `main` commit after the hosted gates pass, and its exact run,
manifest, and checksum will be recorded here before any formal publication.
