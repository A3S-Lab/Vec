...
do not leak storage implementation details. Filter parsing, tokenization, and
index quantization are private modules of this crate and are not re-exported
as part of the A3S contract.
